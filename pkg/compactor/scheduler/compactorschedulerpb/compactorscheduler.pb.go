...
type CompactionClass int32

const (
	COMPACTION_CLASS_ANY  CompactionClass = 0
	COMPACTION_CLASS_FAST CompactionClass = 1
	COMPACTION_CLASS_SLOW CompactionClass = 2
)

var CompactionClass_name = map[int32]string{
	0: "COMPACTION_CLASS_ANY",
	1: "COMPACTION_CLASS_FAST",
	2: "COMPACTION_CLASS_SLOW",
}

var CompactionClass_value = map[string]int32{
	"COMPACTION_CLASS_ANY":  0,
	"COMPACTION_CLASS_FAST": 1,
	"COMPACTION_CLASS_SLOW": 2,
}

func (CompactionClass) EnumDescriptor() ([]byte, []int) {
...
type LaneRequest struct {
	...
	CompactionClass CompactionClass `protobuf:"varint,2,opt,name=compaction_class,json=compactionClass,proto3,enum=compactorschedulerpb.CompactionClass" json:"compaction_class,omitempty"`
}
...
func (m *LaneRequest) GetCompactionClass() CompactionClass {
	if m != nil {
		return m.CompactionClass
	}
	return COMPACTION_CLASS_ANY
}
...
func init() {
	...
	proto.RegisterEnum("compactorschedulerpb.CompactionClass", CompactionClass_name, CompactionClass_value)
...
var fileDescriptor_cc7d2e2996592602 = []byte{
	...
	,
}
...
func (x CompactionClass) String() string {
	s, ok := CompactionClass_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *LaneRequest) Equal(that interface{}) bool {
	...
	if this.CompactionClass != that1.CompactionClass {
		return false
	}
	return true
}
...
func (this *LaneRequest) GoString() string {
	...
	s = append(s, "JobType: "+fmt.Sprintf("%#v", this.JobType)+",\n")
	s = append(s, "CompactionClass: "+fmt.Sprintf("%#v", this.CompactionClass)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *LaneRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CompactionClass != 0 {
		i = encodeVarintCompactorscheduler(dAtA, i, uint64(m.CompactionClass))
		i--
		dAtA[i] = 0x10
	}
	if m.JobType != 0 {
...
func (m *LaneRequest) Size() (n int) {
	...
	if m.CompactionClass != 0 {
		n += 1 + sovCompactorscheduler(uint64(m.CompactionClass))
	}
	return n
}
...
func (this *LaneRequest) String() string {
	...
	s := strings.Join([]string{`&LaneRequest{`,
		`JobType:` + fmt.Sprintf("%v", this.JobType) + `,`,
		`CompactionClass:` + fmt.Sprintf("%v", this.CompactionClass) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LaneRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompactionClass", wireType)
			}
			m.CompactionClass = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CompactionClass |= CompactionClass(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
